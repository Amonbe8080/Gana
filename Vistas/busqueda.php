    ...
    <div class='container-fluid mt-5'>
        <div class='card mb-12 wow'>
            <div class='card-body d-sm-flex justify-content-center'>
                <input class='form-control col-md-3 mr-sm-2 mt-2' type='number' id='dniReceptor' placeholder='Buscar' aria-label='Buscar' minlength='6' maxlength='11' min='0' required> 
